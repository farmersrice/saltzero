...
class SaltZeroAgent(Agent):
    ...
    def get_best_move(self, board):
        ...
        pi, v = self.tree_search.get_probabilities_and_best_move(
            board, False, 1 if self.move_counter <= 2 and self.use_temp else 0
        )  # not training, temp = 0 (pick one with most visits)
